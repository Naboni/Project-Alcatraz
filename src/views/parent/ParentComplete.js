...
export default function ParentComplete() {
    ...
    function handleOnSubmit() {
        console.log();
        fetch("http://127.0.0.1:5000/parent", {
            method: "POST",
            headers: {
            ...
            if (!body.message) {
              ...
              history.replace(`/user/${kuki.user_role}`);
            } else {
    ...
    return (
        <>
            <div className=" w-full h-full">
                <div className="ml-auto mr-auto mt-5 relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0 lg:w-6/12">
                            ...
                            <div className="flex flex-wrap">
                                <div className="w-full lg:w-12/12 px-4">
                                    <div className="relative w-full mb-3">
                                        ...
                                        <textarea type="text" className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" defaultValue="" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
